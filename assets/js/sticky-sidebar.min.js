        ...
        [
          ...
          },
          {
            ...
            value: function () {
              var t;
              this._breakpoint ||
                (((t = this.dimensions).containerTop = p.offsetRelative(
                  this.container
                ).top),
            ...
            value: function () {
              ...
              (t.sidebarLeft = p.offsetRelative(this.sidebar).left),
                ...
                "function" == typeof t.topSpacing &&
                  (t.topSpacing = parseInt(t.topSpacing(this.sidebar)) || 0),
              ...
              return (
                this.isSidebarFitsViewport()
                  ...
                  ? ((t.translateY = t.containerBottom - e),
                    (s = "CONTAINER-BOTTOM"))
                  : e + t.translateY <= n
                  ? ((t.translateY = n - e), (s = "VIEWPORT-BOTTOM"))
            ...
            value: function () {
              ...
              return (
                i <= t.translateY + t.containerTop
                  ? ((t.translateY = i - t.containerTop), (s = "VIEWPORT-TOP"))
                  : t.containerBottom <= n
                  ? ((t.translateY = t.containerBottom - e),
                    (s = "CONTAINER-BOTTOM"))
                  : this.isSidebarFitsViewport() ||
          ...
          },
          {
            ...
            value: function (t) {
              if (void 0 !== t) {
                ...
                return (
                  (e.outer = p.extend({ height: "", position: "" }, e.outer)),
                  (e.inner = p.extend(
                    {
                      position: "relative",
                      top: "",
